        ...
        <section class="SignUpMain">
            ...
            <div class="SignUpMain__form">
                ...
                <div class="SignUpMain__input">
                    <input id="pseudoInput" class="SignUpMain__input-type" type="pseudo" placeholder="Pseudo" aria-label="Entrez votre pseudo" v-model="pseudo" v-on:keydown="regex = false">
                ...
                <div class="SignUpMain__input">
                    <input id="mailInput" class="SignUpMain__input-type" type="mail" placeholder="Email" aria-label="Entrez votre adresse mail" v-model="email">
                ...
                <div class="SignUpMain__checkbox">
                    <input class="SignUpMain__checkbox-type" type="checkbox" aria-label="Veuillez accepter nos CGU" v-model="acceptTerms" >
                    ...
                    <span class="SignUpMain__input-error" v-if="v$.acceptTerms.$error"> Veuillez entrer un mot de passe correct  </span>
                </div>
                ...
                <div class="SignUpMain__button">
                    ...
                    <div class="MainHeader__option-content" v-if="popup">
